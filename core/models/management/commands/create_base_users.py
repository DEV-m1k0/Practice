    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            with Session(engine) as session:
                ...
                new_user = User(username="user", password=user_password,
                ...
                new_organizer = User(username="organizer", password=organizer_password,
                ...
                new_moderator = User(username="moderator", password=moderator_password,
                ...
                new_jury = User(username="jury", password=jury_password,
